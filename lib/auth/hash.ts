...
/** Hashea una contraseña como `scrypt$N$saltHex$hashHex`. Sin `server-only`: lo usan tanto
 * `lib/auth/password.ts` (server) como `prisma/seed.ts`, que corre fuera de Next con `tsx`. */

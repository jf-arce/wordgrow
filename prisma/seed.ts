...
const DECKS: DeckSpec[] = [
  ...
  {
    name: "Frases útiles",
    description: "Expresiones cortas para el día a día, en inglés.",
    color: "rose",
    lang: "en-US",
    cards: [
      se("I'd like a coffee, please.", "Quisiera un café, por favor.", "Pedir algo en un bar."),
      se("How's it going?", "¿Cómo andás?", "Saludo informal."),
      se("I don't understand.", "No entiendo.", "Cuando no entendés algo."),
      se("Could you repeat that, please?", "¿Puede repetir, por favor?", "Pedir que repitan."),
      w("thanks", "gracias", "Thanks so much for your help."),
      w("welcome", "bienvenido/a", "Welcome to our home!"),
      w("sorry", "lo siento", "Sorry, I'm running late."),
      ot("See you soon", "hasta pronto", "See you soon, my friend!"),
      ot("Enjoy your meal", "buen provecho", "Enjoy your meal, everyone!"),
      ot("Works for me", "dale; hecho (informal)", "Shall we meet at noon? – Works for me!"),
    ],
  },
];
